...
write_csv(max_bf_sd, file = here("data/avg_bf_plus_sd.csv"))
write_csv(max_bf_sd_males, file = here("data/avg_bf_plus_sd_males.csv"))
write_csv(max_bf_sd_females, file = here("data/avg_bf_plus_sd_females.csv"))
```