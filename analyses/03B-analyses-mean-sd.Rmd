...
```{r}
lepidosaur <- comparative.data(phy = tree_plus, data = max_bf_sd, 
...
# Females only
lepidosaur_females <- comparative.data(phy = tree_plus, data = max_bf_sd_females, 
                               names.col = tips, vcv = TRUE,
                               warn.dropped = FALSE, na.omit = FALSE)
...
# Males only
lepidosaur_males <- comparative.data(phy = tree_plus, data = max_bf_sd_males, 
                               names.col = tips, vcv = TRUE,
                               warn.dropped = FALSE, na.omit = FALSE)
...
lepidosaur_x <- comparative.data(phy = tree_plus, data = max_bf_sd_x, 
                               names.col = tips, vcv = TRUE,
                               warn.dropped = FALSE, na.omit = FALSE)
...
lepidosaur_females_x <- comparative.data(phy = tree_plus, data = max_bf_sd_females_x, 
                               names.col = tips, vcv = TRUE,
                               warn.dropped = FALSE, na.omit = FALSE)
...
lepidosaur_males_x <- comparative.data(phy = tree_plus, data = max_bf_sd_males_x, 
                               names.col = tips, vcv = TRUE,
                               warn.dropped = FALSE, na.omit = FALSE)
```
...
```{r}
#write_csv(output, path = here("outputs/meansd/pgls-results-meansd.csv"))
```