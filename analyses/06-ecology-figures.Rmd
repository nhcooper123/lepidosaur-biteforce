...
model1f <- pgls(log(max_bf) ~ log(max_svl) * as.factor(fossorial), data = lepidosaur,
                   lambda = "ML")
model1ac <- pgls(log(max_bf) ~ log(max_svl) * as.factor(acrodont), data = lepidosaur,
                   lambda = "ML")
...
model2f <- pgls(log(max_bf) ~ log(max_hw) * as.factor(fossorial), data = lepidosaur,
                   lambda = "ML")
model2ac <- pgls(log(max_bf) ~ log(max_hw) * as.factor(acrodont), data = lepidosaur,
                   lambda = "ML")
# HL
...
model3f <- pgls(log(max_bf) ~ log(max_hl) * as.factor(fossorial), data = lepidosaur,
                   lambda = "ML")
model3ac <- pgls(log(max_bf) ~ log(max_hl) * as.factor(acrodont), data = lepidosaur,
                   lambda = "ML")
...
model4f <- pgls(log(max_bf) ~ log(max_hh) * as.factor(fossorial), data = lepidosaur,
                   lambda = "ML")
model4ac <- pgls(log(max_bf) ~ log(max_hh) * as.factor(acrodont), data = lepidosaur,
                   lambda = "ML")
```
